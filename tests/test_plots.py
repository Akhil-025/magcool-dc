...
FIGURE_FUNCTIONS = [
    ...
    (plots.plot_value_proposition_cop_crossover,
     "fig36_value_proposition_cop_crossover"),
    (plots.plot_value_proposition_emissions_breakdown,
     "fig37_value_proposition_emissions_breakdown"),
    (plots.plot_value_proposition_refrigerant_gwp,
     "fig38_value_proposition_refrigerant_gwp"),
    (plots.plot_value_proposition_real_deployments,
     "fig39_value_proposition_real_deployments"),
    (plots.plot_mnfepsi_doped_hysteresis_speculative,
     "fig40_mnfepsi_doped_hysteresis_speculative"),
    (plots.plot_mnfepsi_hysteresis_kfit_quality,
     "fig41_mnfepsi_hysteresis_kfit_quality"),
    (plots.plot_hysteresis_exploiting_actuator_estimate,
     "fig42_hysteresis_exploiting_actuator_estimate"),
    (plots.plot_hysteresis_loss_landscape,
     "fig43_hysteresis_loss_landscape"),
    (plots.plot_calibration_drift_phase37,
     "fig44_calibration_drift_phase37"),
    (plots.plot_lozano_calibration_status,
     "fig45_lozano_calibration_status"),
    (plots.plot_alternative_caloric_comparison,
     "fig46_alternative_caloric_comparison"),
    (plots.plot_water_usage_comparison,
     "fig47_water_usage_comparison"),
    (plots.plot_uncertainty_propagation,
     "fig48_uncertainty_propagation_band"),
    (plots.plot_pareto_multiseed_stability,
     "fig49_pareto_multiseed_stability"),
    (plots.plot_regime_crossover_analysis,
     "fig50_regime_crossover_analysis"),
    (plots.plot_heat_pump_validation,
     "fig51_heat_pump_validation"),
    (plots.plot_hypereg_analysis,
     "fig52_hypereg_analysis"),
    (plots.plot_regenerative_amplification_gap,
     "fig53_regenerative_amplification_gap_corpus"),
    (plots.plot_hmr_vs_vcc_loss_funnel,
     "fig54_hmr_vs_vcc_loss_funnel"),
    (plots.plot_annualized_climate_comparison,
     "fig55_annualized_climate_comparison"),
    (plots.plot_fluid_selection_comparison,
     "fig56_fluid_selection_comparison"),
    (plots.plot_commercial_landscape_check,
     "fig57_commercial_landscape_check"),
    (plots.plot_calibrated_gd_system_impact,
     "fig58_calibrated_gd_system_impact"),
    (plots.plot_regenerator_1d_validation,
     "fig59_regenerator_1d_validation"),
    (plots.plot_field_dependent_broadening_calibration,
     "fig60_field_dependent_broadening_calibration"),
    (plots.plot_magnet_geometry_multiseed_stability,
     "fig61_magnet_geometry_multiseed_stability"),
]
...
def test_plot_material_family_comparison_color_count_matches_candidates(_redirect_plot_output):
    """ added a 6th material-family candidate (the
    nanocomposite blend);  added a 7th (Ga1-xCMn3+x antiperovskite);
     added an 8th (Mn1-xCuxCoGe). plot_material_family_comparison()'s
    colors8 list must cover at least as many entries as build_comparison_table()
    returns for the representative span, or matplotlib's bar(color=...)
    raises a length-mismatch error -- this is the regression guard
    core/plots.py's own comment above colors8 points to."""
