...
| Quantity | Value | Source |
|---|---|---|
| Plate spacing (fluid gap) | 0.1-0.2 mm typical; earlier COP-optimum found at 0.1mm at the 291K/10K operating point | `core/geometry_analysis.py` |
