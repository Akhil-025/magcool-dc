...
|---|---|---|
| Particle diameter `d_p` | 0.5 mm default; sweep 0.05–2 mm | An earlier geometry sweep found COP-optimal packed-bed diameter at 0.5mm for the 291K/10K-span/2kg/1Hz/1.5T operating point — **not necessarily optimal** at the 1.13T/10.2K-span/1.7kg/0.75Hz benchmark used for the Step 21 degeneracy check |
...
| Quantity | Value | Source |
|---|---|---|
| Plate spacing (fluid gap) | 0.1-0.2 mm typical; earlier COP optimum found at 0.1 mm | `core/geometry_analysis.py` |
